...
# @dp.message_handler(commands=['moderator'], is_сhat_admin=True)
...
# Ловим последний ответ и используем полученные даные
...
# @dp.register_message_handler(lambda x :x.data and x.data.startswith('del '))
...
def register_handler_admin(dp: Dispatcher):
    ...
    # dp.register_message_handler(del_callback_run, text='Удалена')
